...
class EditClientActivity : AppCompatActivity() {
    ...
    private lateinit var clientList: MutableList<RealClient>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        clientList = XmlManager.loadRealClients(this).toMutableList()

        val originalClient = clientList.find { it.id == originalClientId }

        originalClient?.let {
            binding.editClientName.setText(it.fullName)
        ...
        binding.saveClientButton.setOnClickListener {
            ...
            if (index != -1) {
                ...
                XmlManager.saveRealClients(this, clientList)
