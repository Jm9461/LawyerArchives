...
class EditCaseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.saveCaseButton.text = "ویرایش پرونده"
        setupClickListeners()
    }
    ...
    private fun setupClickListeners() {
        ...
        binding.saveCaseButton.setOnClickListener { updateCase() }
    }

    private fun showDatePickerDialog() {
        val currentDate = binding.etFormationDate.text.toString()
        PersianDatePickerHelper.showPersianDatePicker(this, currentDate) { selectedDate ->
            binding.etFormationDate.setText(selectedDate)
        }
    }
    ...
    private fun updateCase() {
        currentCase?.let { existingCase ->
            ...
            if (formationDate.isEmpty() || clientName.isEmpty() || clientRole.isEmpty() ||
                caseSubject.isEmpty() || status.isEmpty() || process.isEmpty() ||
