...
public final class ActivityEditMeetingBinding implements ViewBinding {
  ...
  private ActivityEditMeetingBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static ActivityEditMeetingBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityEditMeetingBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_edit_meeting, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityEditMeetingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEditMeetingBinding((LinearLayout) rootView, editClientName, editDuration,
